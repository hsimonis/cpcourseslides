...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{images/monash_title_slide.pdf}}
\begin{frame}[plain]
\end{frame}
}
...
\only<+->{\begin{textblock*}{6cm}(0cm,1cm)
...
\end{textblock*}}
\only<+->{\begin{textblock*}{6cm}(5cm,3cm)
...
\only<7>{\begin{textblock*}{5cm}(9cm,3cm)
