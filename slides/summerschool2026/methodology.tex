...
\begin{frame}
  ...
  \includegraphics[width=10cm]{../summerschool2026/images/ntpf}
  \end{frame}
...
\begin{frame}
  ...
  \includegraphics[width=10cm]{../summerschool2026/images/iconloop}
\end{frame}
...
\begin{frame}[fragile]
 ...
 software/.style = {draw,rectangle,rounded corners,fill=brown!20,align=center},
  ...
  \node[software,below=of samples] (modelseeker)  {Constraint Acquisition};
