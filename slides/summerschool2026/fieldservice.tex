...
\begin{frame}
\frametitle{Elevator Maintenance Planning and Scheduling}
\begin{itemize}
\item Project with UTRC (Ireland, US) and Otis (Canada)
\item Plan and schedule maintenance of elevators/lifts/escalators
\item Shows importance of overall problem decomposition
\end{itemize}
\end{frame}
